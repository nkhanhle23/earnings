...
ENV DATABASE_REMOTE="https://doltremoteapi.dolthub.com/nkhanhle23/earnings"
ENV DATABASE_NAME=earnings
ENV DOLTHUB_USER=nkhanhle23
ENV DOLTHUB_EMAIL=S_NGUYENK22@STUD.HWR-BERLIN.DE
ENV DATA_DIR="/dolthub-dbs/nkhanhle23/$DATABASE_NAME"
...
create_directories() {
  ...
  _create_dir "/dolthub-dbs/nkhanhle23"
}
...
WORKDIR /dolthub-dbs/nkhanhle23
